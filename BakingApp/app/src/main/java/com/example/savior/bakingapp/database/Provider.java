package com.example.savior.bakingapp.database;
...
import com.example.savior.bakingapp.database.Contract.RecipeEntry;

import static com.example.savior.bakingapp.database.Contract.CONTENT_AUTHORITY;
import static com.example.savior.bakingapp.database.Contract.PATH_RECIPE;
...
public class Provider extends ContentProvider {
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.example.savior.bakingapp.ACTION_DATA_UPDATED";

    private static final UriMatcher sUriMatcher = buildUriMatcher();

    private CHelper mOpenHelper;
    ...
    public boolean onCreate() {
        mOpenHelper = new CHelper(getContext());
        return true;
    }
